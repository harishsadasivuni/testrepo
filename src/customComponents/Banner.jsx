        ...
        <banner id="banner">
            <div className="custom-banner-left" >
                ...
                <div className="banner-link">
                    <OffCanvasBottom key="bottom" placement="bottom" name="View Resume" url="https://aparnad301.github.io/resume/" />
                    <Button href="#about" variant="outline-primary">About me</Button>
                </div>
            </div>
